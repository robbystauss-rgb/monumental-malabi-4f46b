...
const catalog = {
  ...
  rules: [
    'Keep hat style/model and color linked; never expose a color under the wrong model.',
    'featured_options are the smaller Canva Available Colors/in-stock selections when present.',
    'options are the complete verified catalog found across Drive and Canva and may include special-order colors.',
    'Before promising immediate availability, verify current blank-hat stock or use special-order wording.'
  ],
  models: {
    'Richardson 112': {
